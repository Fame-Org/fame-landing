            ...
            <div className="who-we-contant">
              ...
              <li>
                <p className="wow fadeInUp" data-wow-delay="0.4s">
                  <b>Educate on ALGORAND</b> by adding and using $FAME, our ALGO
                  FAM COMMUNITY is getting familiar to use our $FAME ASA and
                  sending transactions to different wallets.
                </p>
              </li>
              <li>
                <p className="wow fadeInUp" data-wow-delay="0.4s">
